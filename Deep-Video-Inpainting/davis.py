...
class DAVIS(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for f in f_list:
            ...
            img_file = os.path.join(self.image_dir, video, '{:06d}.jpg'.format(f))
            ...
            try:
                mask_file = os.path.join(self.mask_dir, video, '{:06d}.png'.format(f))
            except:
                mask_file = os.path.join(self.mask_dir, video, '000000.png')
